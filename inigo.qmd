---
output-file: index
title: "The TCTrack Software for Cyclone Tracking"
format:
  revealjs:
...
![Tracks generated using Tempest Extremes from JFM 1950 HadGEM3 data](../images/cyclone_tracks.png){width=100%}
...
## Wrapping rather than re-implementing {.smaller}
...
Read the docs, docstrings in code, add documentation for the wrapped codes.

![](images/read-the-docs.png){width=45% style="vertical-align: bottom;"}
![](images/api-docs.png){width=40% style="vertical-align: bottom;"}

<!-- =============================================================================== -->

## Documentation - Tutorial {.smaller}

<!-- =============================================================================== -->

## Documentation - Preprocessing {.smaller}
...
![](images/TE_Tracks.png){width=80%}
:::
::: {.column style="width: 50%; text-align: center;"}
TRACK

![](images/TRACK_Tracks.png){width=80%}
:::
::::
...
## Raw Output Data: TE GFDL {.smaller}
...
## Raw Output Data: TE CSV {.smaller}
...
## Future Work - MPhil {.smaller}

<!-- =============================================================================== -->

## Future Work - JOSS paper {.smaller}
...
![](https://github.com/Cambridge-ICCS/handbook/blob/9aae79eef7fac90373e3345456e27ee1a31f9179/templates/_Final%20logos/Logo%20on%20its%20own.png){style="width: 20%; height: 30%; object-fit: cover; object-position: 0 0;" .absolute top=33% right=5%}
