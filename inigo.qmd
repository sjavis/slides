...
- Input parameter lists, e.g. `DetectParameters`, `StitchParameters`,
- Running the tracker & outputing results, e.g. `Tracker`,

providing a uniform approach to all tracking algorithms.
...
It works in the Northern Atlantic too.

:::: {.columns}
::: {.column style="width: 100%; text-align: center;"}
![](images/atlantic_1950.png){width=65%}
:::
:::
...
## Docs - Contributing {.smaller}

<br>
Community contributions are encouraged and guided.

![](images/docs-contributing.png)
...
- [CF-Conventions 2025 Annual Workshop](https://cfconventions.org/Meetings/2025-Workshop.html) (invited talk)
- Internal presentation to ICCS 
- INIGO Quarterly meetings

Future:

- Submission to European Geosciences Union 2026\ _"Integrated advances in tropical cyclones: linking physics, impacts, risks and adaptation"_
- JOSS and RSECon Submission

![](images/JOSS_logo.jpg){style="width: 20%;" .absolute bottom=70% right=15%}
![](images/EGU_logo.svg){style="width: 20%;" .absolute bottom=50% right=5%}

Support in publicising this work and finding new users and contributors is appreciated.

<!-- =============================================================================== -->

## Future Work - Applications {.smaller}

TCTrack will be used in MPhil projects at Cambridge

- Use TCTrack on CMIP data to look at
  - intensity and frequency of storms
  - using different tracking approaches
  - on different data sets
- in an updated analysis of @knutson2015global.
- Larger scale test of the package.
- Identify potential areas for improvement.
- Results will contribute to EGU poster.
...
- Tune parameters of the TRACK algorithm
- Wrap further storm tracking softwares
  - cytrack
  - Robert's ML algorithm
...
Thanks to Alison Ming and\
Charles Powell

\

The ICCS received support from\
![](images/inigo_inspire.png){height=2.4em style="margin: 0; vertical-align: -2%"}
:::
::::
...
![](images/TCTrack_Logo.svg){style="width: 20%;" .absolute bottom=15% right=5%}
